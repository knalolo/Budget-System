...
from .views import (
    ...
    purchase_request_approve_cancellation,
    purchase_request_dataset_export,
    purchase_request_delete,
    purchase_request_reject,
    purchase_request_reject_cancellation,
    purchase_request_request_cancellation,
...
urlpatterns = [
    ...
    path("<int:pk>/request-cancellation/", purchase_request_request_cancellation, name="purchase-request-request-cancellation"),
    path("<int:pk>/approve-cancellation/", purchase_request_approve_cancellation, name="purchase-request-approve-cancellation"),
    path("<int:pk>/reject-cancellation/", purchase_request_reject_cancellation, name="purchase-request-reject-cancellation"),
